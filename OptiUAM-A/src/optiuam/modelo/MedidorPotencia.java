       ...
       // boolean isSplitter=false; //para saber si hubo un splitter en el enlace
        for(int i = elementos.size()-1;i>=0;i--){
            if(elementos.get(i).getId_nombre().contains("splitter")){
                ...
                Ps= splitter_aux.getPerdida_insercion();
            ...
            if(elementos.get(i).getId_nombre().contains("fuente")){
            ...
            if(elementos.get(i).getId_nombre().contains("conector")){
                Conector conector_aux = (Conector)elementos.get(i);
                conectores.add(conector_aux.getPerdida_insercion());
            }
            
            if(elementos.get(i).getId_nombre().contains("fibra")){
            ...
            if(elementos.get(i).getId_nombre().contains("empalme")){
                Empalme empalme_aux = (Empalme)elementos.get(i);
                empalmes.add(empalme_aux.getPerdida_insercion());
            }
        }
